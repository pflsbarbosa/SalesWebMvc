...
namespace SalesWebExerciseMvc.Data
{
    ...
    {
        private SalesWebExerciseMvcContext _context;

        // SeedingService for dependency injection system
        // SeedingService it is a client
        // SalesWebExerciseMvcContext it is the service
        /* The code that passes the service to the client 
        can be many kinds of things and is called the injector.
        Instead of the client specifying which service it will use,
        the injector tells the client what service to use. The "injection"
        refers to the passing of a dependency (a service)
        into the object (a client) that would use it. */

        public SeedingService(SalesWebExerciseMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Department d5 = new Department {Name = "Suport" };
            ...
            Seller s7 = new Seller {Name = "Paulo Wolf", Email = "paulwolf@gmail.com", BirthDate = new DateTime(1998, 4, 21), BaseSalary = 1000.0, Department = d1 };
            ...
            SalesRecord r31 = new SalesRecord( new DateTime(2018, 10, 15), 6000.0, SaleStatus.Billed, s7);
